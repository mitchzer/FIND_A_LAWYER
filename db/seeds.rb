...
@user1 = User.create!(first_name: "Diogo Telo", email: "Diogo@gmail.com", password: "password")
@user2 = User.create!(first_name: "Swen Künzel", email: "Swen@gmail.com", password: "password")
@user3 = User.create!(first_name: "Emily Burns", email: "Emily@gmail.com", password: "password")
@user4 = User.create!(first_name: "Ally Patricio", email: "Ally@gmail.com", password: "password")
@user5 = User.create!(first_name: "Jerome Harveng", email: "Jerome@gmail.com", password: "password")
@user6 = User.create!(first_name: "Monica Nabais", email: "Monica@gmail.com", password: "password")
@user7 = User.create!(first_name: "Pedro Marzagão", email: "Pedro@gmail.com", password: "password")
@user8 = User.create!(first_name: "Antoine Quellier", email: "Antoine@gmail.com", password: "password")
@user9 = User.create!(first_name: "Maria Castro", email: "Maria@gmail.com", password: "password")
@user10 = User.create!(first_name: "Arthur Pfister", email: "Arthur@gmail.com", password: "password")
@user11 = User.create!(first_name: "Todd Johnson", email: "Todd@gmail.com", password: "password")
@user12 = User.create!(first_name: "Boris Paillard", email: "Boris@gmail.com", password: "password")
...
Lawyer.create!( specialty: @family, address: "Cape Town", professional_email: @user4.email, user: @user4 )
